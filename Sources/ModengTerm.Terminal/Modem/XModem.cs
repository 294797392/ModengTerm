...
namespace ModengTerm.Terminal.Modem
{
    ...
    public class XModem : ModemBase
    {
        ...
        public override int Receive(List<string> filePaths)
        {
            ...
            bool xmodem1k = this.Session.GetOption<bool>(PredefinedOptions.XMODEM_XMODEM1K);
            int retry = this.Session.GetOption<int>(PredefinedOptions.MODEM_RETRY_TIMES);
            bool crc = this.Session.GetOption<bool>(PredefinedOptions.XMODEM_RECV_CRC);
            byte padchar = this.Session.GetOption<byte>(PredefinedOptions.XMODEM_RECV_PADCHAR);
            bool ignorePadChar = this.Session.GetOption<bool>(PredefinedOptions.XMODEM_RECV_IGNORE_PADCHAR);
        ...
        public override int Send(List<string> filePaths)
        {
            ...
            this.xmodem1k = this.Session.GetOption<bool>(PredefinedOptions.XMODEM_XMODEM1K);
            this.retry = this.Session.GetOption<int>(PredefinedOptions.MODEM_RETRY_TIMES);
