...
namespace Renci.SshNet
{
    ...
    public class ForwardedPortRemote : ForwardedPort, IDisposable
    {
        ...
        private System.Threading.EventWaitHandle _globalRequestResponse = new System.Threading.AutoResetEvent(false);
        ...
        protected override void StopPort(TimeSpan timeout)
        {
            ...
            System.Threading.WaitHandle.WaitAny(new[] { _globalRequestResponse, Session.MessageListenerCompleted }, timeout);
        ...
        {
            var original = System.Threading.Interlocked.Exchange(ref _pendingChannelCountdown, new CountdownEvent(1));
            if (original != null)
            {
                original.Dispose();
            }
