...
struct vtparser_s
{
	vtparser_config *config;

	vtstates state;
};


static int is_escape(char ch)
{
	return ch == 0x1b;
}
...
vtparser *vtparser_new(vtparser_config *config)
{
...
void vtparser_init(vtparser *parser)
{

}

void vtparser_release(vtparser *parser)
{

}

void vtparser_process_characters(vtparser *parser, char *bytes, int size)
{
