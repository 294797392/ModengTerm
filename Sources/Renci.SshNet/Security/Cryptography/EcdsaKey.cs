...
#pragma warning restore SA1310 // Field names should not contain underscore
        ...
        private static readonly BigInteger Encoded256 = new BigInteger(Encoding.UTF8.GetBytes("nistp256").Reverse());
        private static readonly BigInteger Encoded384 = new BigInteger(Encoding.UTF8.GetBytes("nistp384").Reverse());
        private static readonly BigInteger Encoded521 = new BigInteger(Encoding.UTF8.GetBytes("nistp521").Reverse());
