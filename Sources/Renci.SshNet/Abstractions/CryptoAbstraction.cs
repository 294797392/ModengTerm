...
#else
        public static global::Renci.SshNet.Security.Cryptography.MD5 CreateMD5()
        {
            return new global::Renci.SshNet.Security.Cryptography.MD5();
        }
...
#else
        public static global::Renci.SshNet.Security.Cryptography.SHA1 CreateSHA1()
        {
            return new global::Renci.SshNet.Security.Cryptography.SHA1();
        }
#endif
...
#else
        public static global::Renci.SshNet.Security.Cryptography.SHA256 CreateSHA256()
        {
            return new global::Renci.SshNet.Security.Cryptography.SHA256();
        }
#endif
...
#else
        public static SshNet.Security.Cryptography.RIPEMD160 CreateRIPEMD160()
        {
            throw new NotImplementedException();
            return new SshNet.Security.Cryptography.RIPEMD160();
        }
...
#else
        public static SshNet.Security.Cryptography.HMACRIPEMD160 CreateHMACRIPEMD160(byte[] key)
        {
            throw new NotImplementedException();
            //return new SshNet.Security.Cryptography.HMACRIPEMD160(key);
        }
