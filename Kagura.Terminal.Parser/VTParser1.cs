...
namespace VideoTerminal.Parser
{
    ...
    public class VTParser1
    {
        ...
        public void Open()
        {
            ...
            this.psrState.StateTable = VTStateTables.GroundTable;
            this.psrState.NextState = VTStateTables.GroundTable[0];

            this.Socket = SocketBase.Create(SocketTypes.SSH);
            ...
            while (!socket.EOF)
            {
                ...
                switch (nextState)
                {
                    ...
                    case VTPsrDef.CASE_OSC:
                        {
                             ...
                             */
                            this.psrState.StateTable = VTStateTables.SOSTable;
                    ...
                    case VTPsrDef.CASE_CSI_STATE:
                        {
                            this.psrState.StateTable = VTStateTables.CSITable;
                    ...
                    case VTPsrDef.CASE_ESC:
                        {
                            this.psrState.StateTable = VTStateTables.EscTable;
                    ...
                    case VTPsrDef.CASE_ESC_DIGIT:
                        {
                             ...
                             */
                            //this.psrState.ParameterBytes.Add(c);
                            if (this.psrState.StateTable == VTStateTables.CSITable)
                            {
                                this.psrState.StateTable = VTStateTables.Csi2Table; // xterm-331 charproc.c 2497, TODO:Csi2Table和CsiTable的区别
                            }
                        }
                        break;
                    ...
                    case VTPsrDef.CASE_ESC_SEMI:
                        {
                            if (this.psrState.StateTable == VTStateTables.CSITable)
                            {
                                this.psrState.StateTable = VTStateTables.Csi2Table; // xterm-331 charproc.c 2509
                            }
                        }
                        break;
                    ...
                    case VTPsrDef.CASE_CSI_SPACE_STATE:
                        {
                            // 进入FinalByte状态表
                            this.psrState.StateTable = VTStateTables.CsiSpTable;
                    ...
                    case VTPsrDef.CASE_CSI_IGNORE:
                        {
                            ...
                            this.psrState.StateTable = VTStateTables.CIgTable;
                        }
                        break;
        ...
        private void ParserThreadProc(object state)
        {
        }
